...
@if (session('success'))
    <div id="successToast" class="hidden fixed bottom-8 right-8 z-40 max-w-max bg-green-100 text-green-700 rounded-lg border border-green-200 z-40 px-4 py-3 shadow-lg shadow-green-400/10 transition-transform duration-300 transform scale-0">
